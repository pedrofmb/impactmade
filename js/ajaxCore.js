...
Services.Primary = {
    ...
    Test: function (successFunction, errorFunction) {
        $.ajax({
    ...
    CheckAvailableNumbers: function (successFunction, errorFunction) {
        $.ajax({
    ...
    Login: function (email, password, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateAccount: function (verificationCode, firstName, lastName, email, password, companyName, keepExistingNumber, virtualNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    GetAccountInfo: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateAccountInfo: function (firstName, lastName, companyName, email, mobileNumber, imageBase64, subscribeToNewsLetter, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdatePassword: function (oldPassword, newPassword, successFunction, errorFunction) {
        $.ajax({
    ...
    SignUpRequest: function (firstName, lastName, companyName, contactPhone, emailAddress, numberEmployees, successFunction, errorFunction) {
        $.ajax({
    ...
    ContactUs: function (firstName, emailAddress, subject, message, successFunction, errorFunction) {
        $.ajax({
    ...
    PingLinuxCoreService: function (idLinuxCoreService, successFunction, errorFunction) {
        $.ajax({
...
Services.Local = {
    ...
    GetExamples: function (successFunction, errorFunction) {
        $.ajax({
    ...
    GetExample: function (idOfExample, successFunction, errorFunction) {
        $.ajax({
    ...
    Logout: function (token, successFunction, errorFunction) {
        $.ajax({
    ...
    GetVirtualNumbers: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateVirtualNumber: function (sidVirtualNumber, friendlyName, timeZoneOffset, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteVirtualNumber: function (sidVirtualNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    PurchaseVirtualNumber: function (virtualNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    IsAuthenticated: function (token, successFunction, errorFunction) {
        $.ajax({
    ...
    ValidateXml: function (xmlEncoded, isVoice, successFunction, errorFunction) {
        $.ajax({
    ...
    GetLogics: function (sidVirtualNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    GetLogicXml: function (idLogic, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateLogic: function (sidVirtualNumber, xmlEncoded, name, description, isVoice, isTemp, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateLogic: function (idLogic, xmlEncoded, name, description, weekDaysToAdd, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteLogic: function (idLogic, successFunction, errorFunction) {
        $.ajax({
    ...
    ListUsageSms: function (virtualNumberSid, startDate, endDate, successFunction, errorFunction) {
        $.ajax({
    ...
    ListUsageSmsMedia: function (virtualNumberSid, startDate, endDate, successFunction, errorFunction) {
        $.ajax({
    ...
    ListSms: function (virtualNumberSid, startDate, endDate, pageNumber, filterFrom, filterTo, filterBody, filterIsIncoming, successFunction, errorFunction) {
        $.ajax({
    ...
    GetSms: function (sidSms, successFunction, errorFunction) {
        $.ajax({
    ...
    ListUsageCalls: function (virtualNumberSid, startDate, endDate, successFunction, errorFunction) {
        $.ajax({
    ...
    ListCalls: function (virtualNumberSid, startDate, endDate, pageNumber, filterFrom, filterTo, filterHasRecordings, filterIsIncoming, successFunction, errorFunction) {
        $.ajax({
    ...
    ListUsageRecordings: function (virtualNumberSid, startDate, endDate, successFunction, errorFunction) {
        $.ajax({
    ...
    ListRecordings: function (virtualNumberSid, startDate, endDate, successFunction, errorFunction) {
        $.ajax({
    ...
    GetCall: function (sidCall, successFunction, errorFunction) {
        $.ajax({
    ...
    Call: function (virtualNumberSid, fromNumber, toNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    InitiateOutboundCall: function (sidVirtualNumber, toNumber, idLogic, label, successFunction, errorFunction) {
        $.ajax({
    ...
    ListRecentCalls: function (sidVirtualNumber, filterFrom, filterTo, successFunction, errorFunction) {
        $.ajax({
    ...
    RedirectCall: function (sidCall, idLogic, label, successFunction, errorFunction) {
        $.ajax({
    ...
    GetLocationOfCall: function (callSid, currentLocation, successFunction, errorFunction) {
        $.ajax({
    ...
    ImportContacts: function (vCardContactactsEncoded, successFunction, errorFunction) {
        $.ajax({
    ...
    GetActivePeriodInfo: function (successFunction, errorFunction) {
        $.ajax({
    ...
    PortNumber: function (phoneNumberToPort, data, doc1, doc2, doc3, doc4, successFunction, errorFunction) {
        $.ajax({
    ...
    GetVariableCategories: function (sidVirtualNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    AutoCompleteGetVariableCategories: function (sidVirtualNumber, partialCategoryName, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateVariableCategory: function (sidVirtualNumber, name, description, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateVariableCategory: function (idVariableCategory, newName, newDescription, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteVariableCategory: function (idVariableCategory, successFunction, errorFunction) {
        $.ajax({
    ...
    GetVariables: function (idVariableCategory, successFunction, errorFunction) {
        $.ajax({
    ...
    AutoCompleteGetVariables: function (idCategory, partialVariableName, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateVariable: function (idVariableCategory, variableName, variableType, variableOptionsSeparatedByComma, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateVariable: function (idVariable, variableName, variableType, variableOptionsSeparatedByComma, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteVariable: function (idVariable, successFunction, errorFunction) {
        $.ajax({
    ...
    GetVariableValues: function (idVariableSeparatedByComma, phoneNumbersSeparatedByComma, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateOrCreateVariableValue: function (idVariable, phoneNumber, valueEncoded, successFunction, errorFunction) {
        $.ajax({
    ...
    GetRecording: function (idRecording, successFunction, errorFunction) {
        $.ajax({
    ...
    GetEvents: function (startDate, endDate, pageNumber, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteEvent: function (id, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateEvent: function (idVirtualNumber, idLogic, title, subtitle, date, recipientsSeparatedByComma, successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateEvent: function (idEvent, idVirtualNumber, idLogic, title, subtitle, date, recipientsSeparatedByComa, successFunction, errorFunction) {
        $.ajax({
...
Services.PBX = {
    ...
    HandleCall: function (successFunction, errorFunction) {
        $.ajax({
    ...
    OnCallTerminated: function (successFunction, errorFunction) {
        $.ajax({
    ...
    CanWeSshIntoPbx: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateSip: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateDialplan: function (successFunction, errorFunction) {
        $.ajax({
    ...
    CreateIpPhone: function (DisplayName, BlockInterationalCalling, CallerId, HasVoicemail, VoicemailPin, SendVoicemailToEmail, DeleteVoicemailIfSentByEmail, LogicVacation, LogicUnavailable, LogicBusy, IsOnVacation, SipPassword, successFunction, errorFunction) {
        $.ajax({
    ...
    GetIpPhones: function (successFunction, errorFunction) {
        $.ajax({
    ...
    GetIpPhonesStatus: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateIpPhone: function (idIpPhone, DisplayName, BlockInterationalCalling, CallerId, HasVoicemail, VoicemailPin, SendVoicemailToEmail, DeleteVoicemailIfSentByEmail, LogicVacation, LogicUnavailable, LogicBusy, IsOnVacation, SipPassword, successFunction, errorFunction) {
        $.ajax({
    ...
    RemoveIpPhone: function (idIpPhone, successFunction, errorFunction) {
        $.ajax({
    ...
    CreaateExtension: function (idIpPhone, extension, successFunction, errorFunction) {
        $.ajax({
    ...
    GetExtensions: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateExtension: function (idExtension, newExtension, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteExtension: function (idExtension, successFunction, errorFunction) {
        $.ajax({
    ...
    CreateConference: function (confName, extension, successFunction, errorFunction) {
        $.ajax({
    ...
    GetConferences: function (successFunction, errorFunction) {
        $.ajax({
    ...
    UpdateConference: function (idConference, confName, extension, successFunction, errorFunction) {
        $.ajax({
    ...
    DeleteConference: function (idConference, successFunction, errorFunction) {
        $.ajax({
